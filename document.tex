...
% Change above to what you want, this template is for now mainly designed for report, extreport, article, and extarticle documentclass.
...
\newcommand{\PhysicsPatch}{\usepackage[forcedefaultall]{physics-patch}}
