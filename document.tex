...
\newcounter{physics-patch-short}
\setcounter{physics-patch-short}{0}
% Set physics-patch-short to 0 to use both shortgreek and shortalphabet option for physics-patch language; 1 to use only shortgreek; 2 to use only shortalphabet; 3 to use neither.
