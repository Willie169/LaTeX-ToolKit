...
% Change above to what you want, this template is now mainly designed for the report and article documentclass.
% It is ok to delete the lines 5 to 38. The default behaviors shown in this file will be used if so.
...
\newcommand{\PhysicsPatch}{\usepackage[override,pretend,nosiintegrate,originaldiv,trig,uprightdiff,bolddel,plaindot,shorttextgreek,shortvargreek,shortupgreek,shortupvargreek,shortboldgreek,shortmathrm,shorttext]{physics-patch}}
% Set options you want for physics-patch here.
\input{/usr/share/LaTeX-ToolKit/template.tex}
% Set path to template.tex here.
