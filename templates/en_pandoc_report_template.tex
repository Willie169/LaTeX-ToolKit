...
\usepackage{fontspec,titlesec,titling,setspace,needspace}
\usepackage{amsthm,amsmath,amsfonts,amssymb,dsfont,stmaryrd,unicode-math,mathtools,mathrsfs,textcomp}
\usepackage{diagbox,cellspace,array,booktabs,longtable,enumitem,graphicx,caption,subcaption,float,placeins,xcolor}
\usepackage{tikz,xparse,physics}
...
\ProvideDocumentCommand{\ch}{s o}{%
  \IfBooleanTF{#1}{%
    \IfNoValueTF{#2}{\chapter*}{\chapter*{#2}}%
  }{%
    \IfNoValueTF{#2}{\chapter}{\chapter{#2}}%
  }%
}
...
\usepackage{titletoc}\titlecontents{chapter}[0em]{\addvspace{1em}}{\thecontentslabel\quad}{}{\titlerule*[1pc]{.}\contentspage}\titlecontents{section}[2em]{\addvspace{1em}}{\thecontentslabel\quad}{}{\titlerule*[1pc]{.}\contentspage}\titlecontents{subsection}[4em]{\addvspace{0.5em}}{\thecontentslabel\quad}{}{\titlerule*[1pc]{.}\contentspage}\titlecontents{subsubsection}[6em]{\addvspace{0.5em}}{\thecontentslabel\ }{}{\titlerule*[1pc]{.}\contentspage}
%\usepackage{hanging}
%\usepackage{etoolbox}
