...
% Set SectionLanguage counter to choose the language of the numbering of chapter (if documentclass is not article), section, subsection, and subsubsection: 0 for Arabic, 1 for Traditional Chinese, 2 for Simplified Chinese. If xeCJK package is not loaded, this counter will be omitted and Arabic will be used.
\newcounter{ZhRenew}
