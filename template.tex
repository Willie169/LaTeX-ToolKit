...
\newfontfamily\MonoTC{Noto Sans Mono CJK TC}[Ligatures=TeX]
...
\newfontfamily\MonoSC{Noto Sans Mono CJK SC}[Ligatures=TeX]
...
\newfontfamily\MonoHK{Noto Sans Mono CJK HK}[Ligatures=TeX]
...
\newfontfamily\MonoJP{Noto Sans Mono CJK JP}[Ligatures=TeX]
...
\newfontfamily\MonoKR{Noto Sans Mono CJK KR}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=2
\newfontfamily\SansTC{Noto Sans CJK TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif CJK TC}[Ligatures=TeX]
...
\newfontfamily\MonoKR{Noto Sans Mono CJK KR}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=3
\newfontfamily\SansTC{Noto Sans CJK TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif CJK TC}[Ligatures=TeX]
\newfontfamily\MonoTC{Noto Sans Mono CJK TC}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans CJK SC}[Ligatures=TeX]
...
\newfontfamily\SansKR{Noto Sans CJK KR}[Ligatures=TeX]
\newfontfamily\SerifKR{Noto Serif CJK KR}[Ligatures=TeX]
\newfontfamily\MonoKR{Noto Sans Mono CJK KR}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=4
\newfontfamily\SansTC{Noto Sans CJK TC}[Ligatures=TeX]
\newfontfamily\TC{Noto Sans CJK TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif CJK TC}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans CJK SC}[Ligatures=TeX]
...
\setmonojfont{Noto Sans Mono CJK TC}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
...
\setmonojfont{Noto Sans Mono CJK SC}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
...
\setmonojfont{Noto Sans Mono CJK HK}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
...
\setmonojfont{Noto Sans Mono CJK JP}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
...
\setmonojfont{Noto Sans Mono CJK KR}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
...
\fi
\makeatletter
\@ifclassloaded{article}{}{\@ifclassloaded{extarticle}{}{
