...
\setCJKmainfont{Noto Sans TC}[Ligatures=TeX]
\setCJKsansfont{Noto Serif TC}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKtc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setCJKmainfont{Noto Serif TC}[Ligatures=TeX]
\setCJKsansfont{Noto Sans TC}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKtc}[Ligatures=TeX]
...
\ifnum\value{CJKFonts}=1
\setCJKmainfont{Noto Sans SC}[Ligatures=TeX]
\setCJKsansfont{Noto Serif SC}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKsc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setCJKmainfont{Noto Serif SC}[Ligatures=TeX]
\setCJKsansfont{Noto Sans SC}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKsc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setCJKmainfont{Noto Sans SC}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKsc}[Ligatures=TeX]
...
\ifnum\value{CJKFonts}=1
\setCJKmainfont{Noto Sans HK}[Ligatures=TeX]
\setCJKsansfont{Noto Serif HK}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKhk}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setCJKmainfont{Noto Serif HK}[Ligatures=TeX]
\setCJKsansfont{Noto Sans HK}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKhk}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setCJKmainfont{Noto Sans HK}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKhk}[Ligatures=TeX]
...
\ifnum\value{CJKFonts}=1
\setCJKmainfont{Noto Sans JP}[Ligatures=TeX]
\setCJKsansfont{Noto Serif JP}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKjp}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setCJKmainfont{Noto Serif JP}[Ligatures=TeX]
\setCJKsansfont{Noto Sans JP}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKjp}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setCJKmainfont{Noto Sans JP}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKjp}[Ligatures=TeX]
...
\ifnum\value{CJKFonts}=1
\setCJKmainfont{Noto Sans KR}[Ligatures=TeX]
\setCJKsansfont{Noto Serif KR}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKkr}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setCJKmainfont{Noto Serif KR}[Ligatures=TeX]
\setCJKsansfont{Noto Sans KR}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKkr}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setCJKmainfont{Noto Sans KR}[Ligatures=TeX]
\setCJKmonofont{Noto Sans MonoCJKkr}[Ligatures=TeX]
...
\newfontfamily\SansTC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\TC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\MonoTC{Noto Sans MonoCJKtc}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans SC}[Ligatures=TeX]
\newfontfamily\SC{Noto Sans SC}[Ligatures=TeX]
\newfontfamily\SerifSC{Noto Serif SC}[Ligatures=TeX]
\newfontfamily\MonoSC{Noto Sans MonoCJKsc}[Ligatures=TeX]
\newfontfamily\SansHK{Noto Sans HK}[Ligatures=TeX]
\newfontfamily\HK{Noto Sans HK}[Ligatures=TeX]
\newfontfamily\SerifHK{Noto Serif HK}[Ligatures=TeX]
\newfontfamily\MonoHK{Noto Sans MonoCJKhk}[Ligatures=TeX]
\newfontfamily\SansJP{Noto Sans JP}[Ligatures=TeX]
\newfontfamily\JP{Noto Sans JP}[Ligatures=TeX]
\newfontfamily\SerifJP{Noto Serif JP}[Ligatures=TeX]
\newfontfamily\MonoJP{Noto Sans MonoCJKjp}[Ligatures=TeX]
\newfontfamily\SansKR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\KR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\SerifKR{Noto Serif KR}[Ligatures=TeX]
\newfontfamily\MonoKR{Noto Sans MonoCJKkr}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=2
\newfontfamily\SansTC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\TC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\MonoTC{Noto Sans MonoCJKtc}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans SC}[Ligatures=TeX]
\newfontfamily\SerifSC{Noto Serif SC}[Ligatures=TeX]
\newfontfamily\SC{Noto Serif SC}[Ligatures=TeX]
\newfontfamily\MonoSC{Noto Sans MonoCJKsc}[Ligatures=TeX]
\newfontfamily\SansHK{Noto Sans HK}[Ligatures=TeX]
\newfontfamily\SerifHK{Noto Serif HK}[Ligatures=TeX]
\newfontfamily\HK{Noto Serif HK}[Ligatures=TeX]
\newfontfamily\MonoHK{Noto Sans MonoCJKhk}[Ligatures=TeX]
\newfontfamily\SansJP{Noto Sans JP}[Ligatures=TeX]
\newfontfamily\SerifJP{Noto Serif JP}[Ligatures=TeX]
\newfontfamily\JP{Noto Serif JP}[Ligatures=TeX]
\newfontfamily\MonoJP{Noto Sans MonoCJKjp}[Ligatures=TeX]
\newfontfamily\SansKR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\SerifKR{Noto Serif KR}[Ligatures=TeX]
\newfontfamily\KR{Noto Serif KR}[Ligatures=TeX]
\newfontfamily\MonoKR{Noto Sans MonoCJKkr}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=3
\newfontfamily\SansTC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\MonoTC{Noto Sans MonoCJKtc}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans SC}[Ligatures=TeX]
...
\newfontfamily\SansKR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\SerifKR{Noto Serif KR}[Ligatures=TeX]
\newfontfamily\MonoKR{Noto Sans MonoCJKkr}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=4
\newfontfamily\SansTC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\TC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans SC}[Ligatures=TeX]
...
\newfontfamily\SansKR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\KR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\SerifKR{Noto Serif KR}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=5
\newfontfamily\SansTC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\TC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans SC}[Ligatures=TeX]
...
\newfontfamily\SansKR{Noto Sans KR}[Ligatures=TeX]
\newfontfamily\SerifKR{Noto Serif KR}[Ligatures=TeX]
\newfontfamily\KR{Noto Serif KR}[Ligatures=TeX]\else\ifnum\value{NotoCJKFamily}=6
\newfontfamily\SansTC{Noto Sans TC}[Ligatures=TeX]
\newfontfamily\SerifTC{Noto Serif TC}[Ligatures=TeX]
\newfontfamily\SansSC{Noto Sans SC}[Ligatures=TeX]
\newfontfamily\SerifSC{Noto Serif SC}[Ligatures=TeX]
...
\ifnum\value{CJKLanguage}=0
\ifnum\value{CJKFonts}=1
\setmainjfont{Noto Sans TC}[Ligatures=TeX]
\setsansjfont{Noto Serif TC}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKtc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setmainjfont{Noto Serif TC}[Ligatures=TeX]
\setsansjfont{Noto Sans TC}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKtc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setmainjfont{Noto Sans TC}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKtc}[Ligatures=TeX]
...
\ifnum\value{CJKLanguage}=1
\ifnum\value{CJKFonts}=1
\setmainjfont{Noto Sans SC}[Ligatures=TeX]
\setsansjfont{Noto Serif SC}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKsc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setmainjfont{Noto Serif SC}[Ligatures=TeX]
\setsansjfont{Noto Sans SC}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKsc}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setmainjfont{Noto Sans SC}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKsc}[Ligatures=TeX]
...
\ifnum\value{CJKLanguage}=2
\ifnum\value{CJKFonts}=1
\setmainjfont{Noto Sans HK}[Ligatures=TeX]
\setsansjfont{Noto Serif HK}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKhk}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setmainjfont{Noto Serif HK}[Ligatures=TeX]
\setsansjfont{Noto Sans HK}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKhk}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setmainjfont{Noto Sans HK}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKhk}[Ligatures=TeX]
...
\ifnum\value{CJKLanguage}=3
\ifnum\value{CJKFonts}=1
\setmainjfont{Noto Sans JP}[Ligatures=TeX]
\setsansjfont{Noto Serif JP}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKjp}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setmainjfont{Noto Serif JP}[Ligatures=TeX]
\setsansjfont{Noto Sans JP}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKjp}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setmainjfont{Noto Sans JP}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKjp}[Ligatures=TeX]
...
\ifnum\value{CJKLanguage}=4
\ifnum\value{CJKFonts}=1
\setmainjfont{Noto Sans KR}[Ligatures=TeX]
\setsansjfont{Noto Serif KR}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKkr}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=2
\setmainjfont{Noto Serif KR}[Ligatures=TeX]
\setsansjfont{Noto Sans KR}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKkr}[Ligatures=TeX]
\else\ifnum\value{CJKFonts}=3
\setmainjfont{Noto Sans KR}[Ligatures=TeX]
\setmonojfont{Noto Sans MonoCJKkr}[Ligatures=TeX]
