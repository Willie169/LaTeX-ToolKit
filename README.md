...
- **ChatGPT**
  ...
  - License: All content generated by ChatGPT is used in accordance with [OpenAI's Terms of Use](https://openai.com/policies/terms-of-use).
...
- **egreg**
  ...
  - License: CC BY-SA 3.0
- **egreg**
  - URL: <https://tex.stackexchange.com/questions/96680/a-better-notation-to-denote-arcs-for-an-american-high-school-textbook>
  - License: CC BY-SA 3.0
- **Henri Menke**
